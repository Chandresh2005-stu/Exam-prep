        ...
        <div>
                        ...
                        <div className="card mx-auto mt-2" style={{ height: "320px", width: "100%"  }}>
                            <div className="card-body">
                                <form method='Post' onSubmit={handleSubmit}>
                                    <div className="row">
                                        <div className="col-sm-12">Enter Session Name:</div>
                                        <div className="col-sm-12 mt-2"><input type="text" placeholder='name' className='form-control' name='name' value={form.name} onChange={handleChange} /></div>
                                    </div>
                                    <div className="row">
                                        <div className="col-sm-12">
                                            Description
                                        </div>
                                        <div className="col-sm-12 mt-2"><textarea name='description' value={form.description} onChange={handleChange} className='form-control' placeholder='text area' rows="5"></textarea></div>
                                    </div>
            ...
            <div className="container-fluid pt-4">
                <div className="card mx-auto mt-2 " style={{ height: "320px", width: "100%" }}>
                    <div className='card-body'>
                        <div className="row">
                            <div className="col-sm-12"><h6><u>Session List</u></h6></div>
                        </div>
                        <div className="row">
                            <div className="col-sm-12">
